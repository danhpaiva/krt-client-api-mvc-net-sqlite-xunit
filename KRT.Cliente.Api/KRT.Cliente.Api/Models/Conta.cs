...
public class Conta
{
    ...
    [StringLength(150, ErrorMessage = "O campo NomeTitular deve conter no máximo 150 caracteres.")]
    ...
    [StringLength(150, ErrorMessage = "O campo Email deve conter no máximo 150 caracteres.")]
